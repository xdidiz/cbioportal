...
/**
 *
 * @author Oleguer Plantalech, Sander Tan
 * DaoGsva defines methods that interact with the CGDS database
 *
 */
...
public class DaoGsva {
    ...
    public static int countGsva(int cancerStudy) throws DaoException {
        ...
        try {
            con = JdbcUtil.getDbConnection(DaoGsva.class);
            pstmt = con.prepareStatement
                    ("SELECT count(*) FROM genetic_profile WHERE CANCER_STUDY_ID = ? AND GENETIC_ALTERATION_TYPE LIKE 'GSVA_SCORES'");
