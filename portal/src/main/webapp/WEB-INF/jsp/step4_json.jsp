...
<textarea rows='5' cols='80' id='gene_list' placeholder="Enter MGI Gene Symbols or Gene Aliases" required
name='<%= QueryBuilder.GENE_LIST %>' title='Enter MGI Gene Symbols or Gene Aliases'><%
